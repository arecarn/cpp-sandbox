...
foreach(FIND_SFML_COMPONENT ${SFML_FIND_COMPONENTS})
    ...
    if(
        ...
        set(SFML_${FIND_SFML_COMPONENT_UPPER}_LIBRARY "")
        set(FIND_SFML_MISSING
            "${FIND_SFML_MISSING} SFML_${FIND_SFML_COMPONENT_UPPER}_LIBRARY"
        )
    endif()
...
if(SFML_STATIC_LIBRARIES)
    ...
    macro(find_sfml_dependency output friendlyname)
        ...
        if(${${output}} STREQUAL "${output}-NOTFOUND")
            unset(output)
            set(FIND_SFML_DEPENDENCIES_NOTFOUND
                "${FIND_SFML_DEPENDENCIES_NOTFOUND} ${friendlyname}"
            )
        endif()
    endmacro()
    ...
    if(NOT ${FIND_SFML_WINDOW_COMPONENT} EQUAL -1)
        ...
        elseif(FIND_SFML_OS_MACOSX)
            set(SFML_WINDOW_DEPENDENCIES
                ${SFML_WINDOW_DEPENDENCIES}
                "-framework OpenGL -framework Foundation -framework AppKit -framework IOKit -framework Carbon"
            )
        endif()
...
if(NOT SFML_VERSION_OK)
    # SFML version not ok
    set(FIND_SFML_ERROR
        "SFML found but version too low (requested: ${SFML_FIND_VERSION}, found: ${SFML_VERSION_MAJOR}.${SFML_VERSION_MINOR}.${SFML_VERSION_PATCH})"
    )
    set(SFML_FOUND FALSE)
elseif(SFML_STATIC_LIBRARIES AND FIND_SFML_DEPENDENCIES_NOTFOUND)
    set(FIND_SFML_ERROR
        "SFML found but some of its dependencies are missing (${FIND_SFML_DEPENDENCIES_NOTFOUND})"
    )
    set(SFML_FOUND FALSE)
...
if(SFML_FOUND AND NOT SFML_FIND_QUIETLY)
    message(
        STATUS
        "Found SFML ${SFML_VERSION_MAJOR}.${SFML_VERSION_MINOR}.${SFML_VERSION_PATCH} in ${SFML_INCLUDE_DIR}"
    )
endif()
